...
let
  ...
  src = fetchFromGitHub {
    ...
    rev = "v${version}";
    hash = "sha256-H6Gf5TCkehK8zD3lsxGv2h0y9s8oRgnySN2g0YdJ268=";
  };
...
lib.recurseIntoAttrs {
  otelcol-contrib = mkDistribution {
    ...
    sourceHash = "sha256-sJ3BWOsvNZLvVBTnoRjlQp+xR81754kTSbUwhLB2zuQ=";
    vendorHash = "sha256-m7KuQqHqHMGiyL+FoGdvFhPsm5bHUpzJgezQM2knI6U=";
